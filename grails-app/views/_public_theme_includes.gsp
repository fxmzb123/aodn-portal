...
<link rel="stylesheet" type="text/css" href="${resource(dir: 'css', file: 'tpacTheme.css')}?v=${resourceVersionNumber}"/>

<link rel="stylesheet" type="text/css" href="${createLink(controller: 'home', action: 'css')}?v=${new Date().time}"/>

<link href='https://fonts.googleapis.com/css?family=Arimo:400,700' rel='stylesheet' type='text/css'>

<link rel="stylesheet" type="text/css" href="${resource(dir: 'css', file: 'landing.css')}"/>